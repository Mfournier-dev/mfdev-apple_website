...
const VideoCarousel = () => {
  ...
  useEffect(() => {
    ...
    if (span[videoId]) {
      ...
      const animUpdate = () => { anim.progress(videoRef.current[videoId].currentTime / highlightsSlides[videoId].videoDuration) }
        ...
        <div className="flex-center py-5 px-7 bg-gray-300 backdrop-blur rounded-full">
          {videoRef.current.map((_, index) => (
            <span
              ...
              className="mx-2 w-3 h-3 bg-gray-200 rounded-full relative cursoir-pointer"
            >
              <span
